...
def install_helm_release(release_name, chart_name, namespace, values_file):
...
def main():
    ...
    if not args.create_values_only:
        install_helm_release(args.release_name, args.chart_name, args.namespace, values_file_path)
